...
export const AdminBrandsPanel = () => {
    ...
    return (
        <section className="p-6 bg-zinc-700 text-white rounded-lg shadow-lg">
           ...
           {isModalVisible && <CreateBrandModal isModalVisible={isModalVisible} setIsModalVisible={setIsModalVisible} />}
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                {brands.map((brand) => (
                    <div 
                        ...
                        <AlertDialogDelete onConfirm={() => handleDeleteBrand(brand._id || "")}>
